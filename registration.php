...
$mname=$_POST['mname'];
$lname=$_POST['lname'];
$gender='female';  // Set gender to female by default
...
<div class="col-sm-8">
<input type="email" name="email" id="email"  class="form-control" required="required" onBlur="checkemailAvailability()">
<span id="user-email-availability" style="font-size:12px;"></span>
</div>
</div>
...
<div class="form-group">
<label class="col-sm-4 control-label"><h4 style="color: green" align="left">Correspondense Address </h4> </label>
</div>
...
<div class="form-group">
<label class="col-sm-4 control-label"><h4 style="color: green" align="left">Permanent Address </h4> </label>
</div>
