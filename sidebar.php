...
<li><a href="email.php"><i class="fa fa-files-o"></i>Update And Verify Email</a></li>
<li><a href="imgupload.php"><i class="fa fa-files-o"></i>Upload Profile Image</a></li>
<li><a href="newmail.php"><i class="fa fa-file-o"></i>Send Mail</a></li>
